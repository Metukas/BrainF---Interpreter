...
type State = { DataPointer : int ; DataTape : byte[] ; InstructionPointer : int ; InstructionTape : Instruction list; LoopState : Loop}
...
let moveOne state =
    match state.InstructionTape.[state.InstructionPointer] with
